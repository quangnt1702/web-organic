                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="<%=product.getImage()%>">
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="MainController?action=ShopDetails&productID=<%=product.getProductID()%>"><i class="fa fa-info"></i></a></li>
                                            <li><a href="MainController?action=AddToCart&productID=<%=product.getProductID()%>"><i class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
                                    <div class="product__item__text">
                                        <h6><a href="MainController?action=ShopDetails&productID=<%=product.getProductID()%>"><%=product.getProductName()%></a></h6>
