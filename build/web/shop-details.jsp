...
<html lang="zxx">
    ...
    <body>
        ...
        <%
            ProductDTO product = (ProductDTO) request.getAttribute("PRODUCT_INFO");
        %>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                ...
                                <a href="./index.jsp"><%=product.getCategory()%></a>
                                ...
                                <div class="product__details__quantity">
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            ...
                                            <input type="text" value="1" name="productQuantityOrder" min="1">
                                            <span class="inc qtybtn">+</span>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="productID" value="<%=product.getProductID()%>">
                                <input type="submit" name="action" class="primary-btn" value="ADD TO CART">
