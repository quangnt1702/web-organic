                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6">
                                ...
                                <div class="checkout__input">
                                    ...
                                    <input type="text" placeholder="Receiver Name" class="checkout__input__add" name="receiverName" required>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="checkout__order">
                                    ...
                                    <ul>
                                        ...
                                        %>
                                        <li><%=productDTO.getProductName()%> <span>$<%=productDTO.getProductQuantityOrder() * productDTO.getProductPrice()%></span></li>
                                            <%
                                                        totalCart += productDTO.getProductQuantityOrder() * productDTO.getProductPrice();
                                                    }
                                                }
                                            %>
                                    </ul>
