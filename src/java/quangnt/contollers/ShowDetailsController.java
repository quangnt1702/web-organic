 ...
 * @author ACER
 */
@WebServlet(name = "ShowDetailsController", urlPatterns = {"/ShowDetailsController"})
public class ShowDetailsController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "shop-details.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at ShowDetailsController: " + e.toString());
        } finally {
